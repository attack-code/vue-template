 ...
 */
const useBaseRequestInterceptor = (
  ...
  console.log(requestInterceptorArray);
...
const useRequestInterceptor = (
  axiosService: AxiosInstance,
  requestInterceptorArray: Array<(config: AxiosRequestConfig) => AxiosRequestConfig> = []
) => {
  const interceptors: [(config: AxiosRequestConfig) => AxiosRequestConfig, undefined][] =
...
export { useBaseRequestInterceptor, useRequestInterceptor };
